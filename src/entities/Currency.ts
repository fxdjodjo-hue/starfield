...
/**
 * Componente Currency - gestisce la valuta "Cosmos" del giocatore
 * I Cosmos sono la valuta principale del gioco usata per acquisti e upgrade
 */
export class Currency extends Component {
  private _cosmos: number;
  private _maxCosmos: number;

  constructor(initialCosmos: number = 0, maxCosmos: number = 999999) {
    super();
