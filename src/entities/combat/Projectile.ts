...
export class Projectile extends Component {
  ...
  public projectileType?: 'laser' | 'missile' | 'npc_laser'; // Tipo di proiettile per rendering

  constructor(damage: number, speed: number, directionX: number, directionY: number, ownerId: number, targetId: number | string, lifetime: number = 5000, playerId?: string, projectileType: 'laser' | 'missile' | 'npc_laser' = 'laser') {
    super();
    this.damage = damage;
    this.speed = speed;
