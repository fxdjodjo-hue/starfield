...
export interface ProjectileFiredMessage {
  ...
  damage: number;
  projectileType: 'laser' | 'pet_laser' | 'npc_laser' | 'missile' | 'repair';
...
export interface SetPetModuleMessage extends BaseMessage {
  type: typeof MESSAGE_TYPES.SET_PET_MODULE;
  clientId: string;
