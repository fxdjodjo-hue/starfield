...
exports.SecurityAudit = exports.BoundaryEnforcement = exports.SecurityZone = exports.TRUST_MODEL = exports.SecurityBoundary = void 0;
/**
...
exports.SecurityBoundary = SecurityBoundary;
// ======================================================================
...
class BoundaryEnforcement {
    ...
    static enforceZone(expectedZone) {
        switch (expectedZone) {
            case exports.SecurityZone.CLIENT_ZONE:
                SecurityBoundary.assertClientContext();
                break;
            case exports.SecurityZone.SERVER_ZONE:
                SecurityBoundary.assertServerContext();
                break;
            case exports.SecurityZone.SHARED_ZONE:
...
exports.BoundaryEnforcement = BoundaryEnforcement;
// ======================================================================
