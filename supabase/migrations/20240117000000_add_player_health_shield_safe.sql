-- Add current_health and current_shield to player_currencies table
-- SAFE VERSION: Only adds columns, doesn't reset any data
...
-- Step 2: Update get_player_complete_data_secure to include health/shield
...
-- Step 3: Update update_player_data_secure to save health/shield
